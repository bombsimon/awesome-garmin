...
>
> _This README was last generated at 2024-02-26_.
...
- [garmin-seaside](https://github.com/bombsimon/garmin-seaside) (2024-02-25)
- [garmin-abouttime](https://github.com/samuelmr/garmin-abouttime) (2024-02-25)
- [garmin-watchface-protomolecule](https://github.com/blotspot/garmin-watchface-protomolecule) (2024-02-24)
- [HandAvoidance](https://github.com/pierre-muth/HandAvoidance) (2024-02-22)
- [crystal-face](https://github.com/warmsound/crystal-face) (2024-02-15)
- [late](https://github.com/myneur/late) (2024-02-09)
- [SwissRailwayClock](https://github.com/ahuggel/SwissRailwayClock) (2024-02-09)
...
- [Aviatorlike](https://github.com/shortattentionspan/Aviatorlike) (2022-12-22)
...
- [GarminAnalogWatch](https://github.com/pukao/GarminAnalogWatch) (2018-10-13)
...
- [myFenix](https://github.com/tbrixi/myFenix) (2017-07-28)
...
- [DFDetector](https://github.com/flocsy/DFDetector) - Garmin datafield for developers to demonstrate how multiple datafields can be detected (2024-02-21)
- [spotlight](https://github.com/fabiobaltieri/spotlight) - Petzl Actik Core mod board with Bluetooth LE and Connect IQ remote control. (2024-02-20)
...
- [connectiq-sonos](https://github.com/zmullett/connectiq-sonos) - A Garmin Connect IQ watch widget that controls Sonos speaker groups. (2024-02-11)
- [hasscontrol](https://github.com/hatl/hasscontrol) - Simple garmin widget to control home assistant scenes (2023-12-22)
...
- [otpauth-ciq](https://github.com/uaraven/otpauth-ciq) - ConnectIQ widget for generating TOTP authentication codes. (2023-11-02)
...
- [timerwidget](https://gitlab.com/harryonline/timerwidget) - A repeating timer widget for Connect IQ compatible Garmin watches. (2023-09-25)
...
- [emergencyinfo](https://gitlab.com/harryonline/emergencyinfo) - EmergencyInfo app for Connect IQ (2023-09-25)
...
- [Garmin-NBA-Widget](https://github.com/singh144401/Garmin-NBA-Widget) - NBA widget gives score of Live NBA games with Timer | Monkey C (2017-08-04)
...
- [Garmoticz](https://github.com/akamming/Garmoticz) - Garmin ConnectIQ Frontend for Domoticz (2024-02-25)
- [Garmin-Cold-Plunge](https://github.com/aiMonster/Garmin-Cold-Plunge) - An application for Garmin watches to take a cold plunge bath (2024-02-22)
- [badminton](https://github.com/matco/badminton) - Badminton application for Garmin watches (2024-02-15)
- [Garmin_SD](https://github.com/OpenSeizureDetector/Garmin_SD) - Garmin Watch Seizure Detector - A seizure detector data source based on Garmin IQ watches such as Vivoactive HR (2024-02-12)
...
- [garmodoro](https://github.com/klimeryk/garmodoro) - Pomodoro for Garmin devices using Connect IQ (2024-02-06)
- [garmin-pace-calculator](https://github.com/bombsimon/garmin-pace-calculator) - 👟 A Garmin app to convert speed to pace and pace to speed (2024-02-03)
...
- [connectiq-sailing](https://github.com/dmrrlc/connectiq-sailing) - Sailing app for connectIQ Garmin fenix 3 (2024-01-15)
- [Timer](https://gitlab.com/ravenfeld/Connect-IQ-App-Timer) - Add several timer already registered (2024-01-12)
- [mybiketraffic](https://github.com/kartoone/mybiketraffic) - ConnectIQ app for processing Garmin Varia radar data and counting vehicles. (2023-12-21)
...
- [garmin-otp-authenticator](https://github.com/ch1bo/garmin-otp-authenticator) - Garmin ConnectIQ Widget for One Time Passwords (HOTP / TOTP / Steam Guard) (2023-09-24)
- [wormnav](https://github.com/andan67/wormnav) - Track navigation for Garmin watches (2023-09-22)
...
- [SailingTools](https://github.com/pintail105/SailingTools) - A Garmin watch IQ app designed for sailing. (2023-01-09)
- [Chrono Gym](https://gitlab.com/ravenfeld/Connect-IQ-App-ChronoGym) - Set count and rest timer (2022-12-21)
...
- [S2C](https://github.com/flori/S2C) - App for Garmin Edge computing cadence from speed (2022-08-23)
...
- [](https://github.com/byzanzm/garmin_monkey) - 
...
- [Compass App](https://gitlab.com/ravenfeld/Connect-IQ-App-Compass) - Compass (2021-06-20)
...
- [monky](https://github.com/vladmunteanu/monky) - Virtual Pet Simulation game with built-in minigames for Garmin vivoactive series (2020-07-09)
...
- [fta-monitor-garmin-watchapp](https://github.com/333fred/fta-monitor-garmin-watchapp) - Port of https://github.com/333fred/fta-monitor-watchapp to my new Garmin Vivoactive HR (2019-03-01)
...
- [GarminDB](https://github.com/tcgoetz/GarminDB) - Download and parse data from Garmin Connect or a Garmin watch, FitBit CSV, and MS Health CSV files into and analyze data in Sqlite serverless databases with Jupyter notebooks. (2024-02-21)
- [garmin-dev-tools](https://github.com/flocsy/garmin-dev-tools) - Tools for Garmin CIQ developers (2024-02-21)
- [prettier-extension-monkeyc](https://github.com/markw65/prettier-extension-monkeyc) - A VSCode extension for Garmin MonkeyC (2024-02-18)
- [monkeyc-optimizer](https://github.com/markw65/monkeyc-optimizer) - Utilities for optimizing monkeyc projects (2024-02-18)
- [prettier-plugin-monkeyc](https://github.com/markw65/prettier-plugin-monkeyc) - A prettier plugin for Garmin monkey-c (2024-02-18)
...
- [connectiq-app-rawlogger](https://github.com/cedric-dufour/connectiq-app-rawlogger) - RawLogger (Garmin ConnectIQ) App [GPLv3] (2022-06-10)
- [kumitateru](https://github.com/ggoraa/kumitateru) - Build system for Garmin ConnectIQ. Simple, fast, powerful! (2022-01-03, archived)
- [ciqdb](https://github.com/pzl/ciqdb) - Connect IQ (PRG) parser and debugger (2019-05-17)
...
- [Sleep-as-Android-Garmin-Addon](https://github.com/urbandroid-team/Sleep-as-Android-Garmin-Addon) - Code for both Android part and Garmin part of the Sleep as Android Garmin smartwatch integration (2023-11-28)
...
- [gimporter](https://github.com/gimportexportdevs/gimporter) - Garmin Connect App to import GPX and FIT files (2022-03-25)
...
- [connectiq-logo-analog](https://github.com/douglasr/connectiq-logo-analog) - A jumping point for anyone wanting to build an analog watch face using Garmin Connect IQ. (2024-02-10)
- [open-location-code](https://github.com/google/open-location-code) - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist. (2023-12-18)
...
- [connectiq-samples](https://github.com/douglasr/connectiq-samples) - Connect IQ sample apps, libraries and code snippets (2022-10-12)
- [NextMatchReminder](https://github.com/ZachXu/NextMatchReminder) - Garmin Application including WatchFace project ,Widget project and a share lib which synchronizing data  (2022-07-07)
...
- [garmin-conect](https://github.com/iperformance/garmin-conect) -  (2019-10-10)
